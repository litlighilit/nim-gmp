...
## identifiers starting with __ have been changed to start with mm_
...
#proc gmp_vasprintf*(a2: cstringArray; a3: cstring; a4: va_list): cint {.
#    importc: "gmp_vasprintf", header: "<gmp.h>".}
#proc gmp_vfprintf*(a2: ptr FILE; a3: cstring; a4: va_list): cint {.
...
#proc gmp_vfscanf*(a2: ptr FILE; a3: cstring; a4: va_list): cint {.
#    importc: "gmp_vfscanf", header: "<gmp.h>".}
#proc gmp_vscanf*(a2: cstring; a3: va_list): cint {.importc: "gmp_vscanf", 
#    header: "<gmp.h>".}
#proc gmp_vsscanf*(a2: cstring; a3: cstring; a4: va_list): cint {.
#    importc: "gmp_vsscanf", header: "<gmp.h>".}
...
proc mpz_fits_uint_p*(mm_gmp_z: mpz_srcptr): cint {.importc: "mpz_fits_uint_p", 
    header: "<gmp.h>".}
proc mpz_fits_ulong_p*(mm_gmp_z: mpz_srcptr): cint {.importc: "mpz_fits_ulong_p", 
    header: "<gmp.h>".}
...
proc mpn_add_1*(mm_gmp_dst: mp_ptr; mm_gmp_src: mp_srcptr; mm_gmp_size: mp_size_t; 
                mm_gmp_n: mp_limb_t): mp_limb_t {.importc: "mpn_add_1", 
    header: "<gmp.h>".}
proc mpn_cmp*(mm_gmp_xp: mp_srcptr; mm_gmp_yp: mp_srcptr; mm_gmp_size: mp_size_t): cint {.
    importc: "mpn_cmp", header: "<gmp.h>".}
# this seems to conflict with earlier definition
#proc mpn_sub*(mm_gmp_wp: mp_ptr; mm_gmp_xp: mp_srcptr; mm_gmp_xsize: mp_size_t; 
#              mm_gmp_yp: mp_srcptr; mm_gmp_ysize: mp_size_t): mp_limb_t {.
#    importc: "mpn_sub", header: "<gmp.h>".}
#proc mpn_sub_1*(mm_gmp_dst: mp_ptr; mm_gmp_src: mp_srcptr; mm_gmp_size: mp_size_t; 
#                mm_gmp_n: mp_limb_t): mp_limb_t {.importc: "mpn_sub_1", 
#    header: "<gmp.h>".}
#proc mpn_neg*(mm_gmp_rp: mp_ptr; mm_gmp_up: mp_srcptr; mm_gmp_n: mp_size_t): mp_limb_t {.
#    importc: "mpn_neg", header: "<gmp.h>".}
const 
  GMP_ERROR_NONE* = 0
